...
TEST(get_ordinal_date, Date) {
  EXPECT_TRUE(check(safe::get_ordinal_date(   1/JAN/ 1),    1,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(   1/DEC/31),    1, 364));

  EXPECT_TRUE(check(safe::get_ordinal_date(   2/JAN/ 1),    2,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(   2/DEC/31),    2, 364));

  EXPECT_TRUE(check(safe::get_ordinal_date(   4/JAN/ 1),    4,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(   4/FEB/28),    4,  58));
  EXPECT_TRUE(check(safe::get_ordinal_date(   4/FEB/29),    4,  59));
  EXPECT_TRUE(check(safe::get_ordinal_date(   4/MAR/ 1),    4,  60));
  EXPECT_TRUE(check(safe::get_ordinal_date(   4/DEC/31),    4, 365));

  EXPECT_TRUE(check(safe::get_ordinal_date(9999/JAN/ 1), 9999,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(9999/DEC/31), 9999, 364));
}

TEST(get_ordinal_date, Date16) {
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2002/JAN/ 1)), 2002,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2002/DEC/31)), 2002, 364));

  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2004/JAN/ 1)), 2004,   0));
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2004/FEB/28)), 2004,  58));
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2004/FEB/29)), 2004,  59));
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2004/MAR/ 1)), 2004,  60));
  EXPECT_TRUE(check(safe::get_ordinal_date(Date16(2004/DEC/31)), 2004, 365));
}
...
TEST(get_week_date, Date) {
  EXPECT_TRUE(check(safe::get_week_date(   1/JAN/ 1),    1,  0, 0));
  EXPECT_TRUE(check(safe::get_week_date(   1/JAN/ 2),    1,  0, 1));

  EXPECT_TRUE(check(safe::get_week_date(2005/JAN/ 1), 2004, 52, 5));
  EXPECT_TRUE(check(safe::get_week_date(2005/JAN/ 2), 2004, 52, 6));
  EXPECT_TRUE(check(safe::get_week_date(2005/DEC/31), 2005, 51, 5));
  EXPECT_TRUE(check(safe::get_week_date(2007/JAN/ 1), 2007,  0, 0));
  EXPECT_TRUE(check(safe::get_week_date(2007/DEC/30), 2007, 51, 6));
  EXPECT_TRUE(check(safe::get_week_date(2007/DEC/31), 2008,  0, 0));
  EXPECT_TRUE(check(safe::get_week_date(2008/JAN/ 1), 2008,  0, 1));
  EXPECT_TRUE(check(safe::get_week_date(2008/DEC/28), 2008, 51, 6));
  EXPECT_TRUE(check(safe::get_week_date(2008/DEC/29), 2009,  0, 0));
  EXPECT_TRUE(check(safe::get_week_date(2008/DEC/30), 2009,  0, 1));
  EXPECT_TRUE(check(safe::get_week_date(2008/DEC/31), 2009,  0, 2));
  EXPECT_TRUE(check(safe::get_week_date(2009/JAN/ 1), 2009,  0, 3));
  EXPECT_TRUE(check(safe::get_week_date(2009/DEC/31), 2009, 52, 3));
  EXPECT_TRUE(check(safe::get_week_date(2010/JAN/ 1), 2009, 52, 4));
  EXPECT_TRUE(check(safe::get_week_date(2010/JAN/ 2), 2009, 52, 5));
  EXPECT_TRUE(check(safe::get_week_date(2010/JAN/ 3), 2009, 52, 6));
}
...
TEST(get_ymd, edge) {
  EXPECT_TRUE(check(safe::get_ymd(   1/JAN/ 1),    1,  0,  0));
  EXPECT_TRUE(check(safe::get_ymd(   1/JAN/31),    1,  0, 30));
  EXPECT_TRUE(check(safe::get_ymd(   1/FEB/ 1),    1,  1,  0));
  EXPECT_TRUE(check(safe::get_ymd(   1/FEB/28),    1,  1, 27));
  EXPECT_TRUE(check(safe::get_ymd(   1/MAR/ 1),    1,  2,  0));
  EXPECT_TRUE(check(safe::get_ymd(   1/DEC/ 1),    1, 11,  0));
  EXPECT_TRUE(check(safe::get_ymd(   1/DEC/31),    1, 11, 30));

  EXPECT_TRUE(check(safe::get_ymd(2000/JAN/ 1), 2000,  0,  0));
  EXPECT_TRUE(check(safe::get_ymd(2000/JAN/31), 2000,  0, 30));
  EXPECT_TRUE(check(safe::get_ymd(2000/FEB/ 1), 2000,  1,  0));
  EXPECT_TRUE(check(safe::get_ymd(2000/FEB/28), 2000,  1, 27));
  EXPECT_TRUE(check(safe::get_ymd(2000/FEB/29), 2000,  1, 28));
  EXPECT_TRUE(check(safe::get_ymd(2000/MAR/ 1), 2000,  2,  0));
  EXPECT_TRUE(check(safe::get_ymd(2000/DEC/ 1), 2000, 11,  0));
  EXPECT_TRUE(check(safe::get_ymd(2000/DEC/31), 2000, 11, 30));

  EXPECT_TRUE(check(safe::get_ymd(9999/JAN/ 1), 9999,  0,  0));
  EXPECT_TRUE(check(safe::get_ymd(9999/JAN/31), 9999,  0, 30));
  EXPECT_TRUE(check(safe::get_ymd(9999/FEB/ 1), 9999,  1,  0));
  EXPECT_TRUE(check(safe::get_ymd(9999/FEB/28), 9999,  1, 27));
  EXPECT_TRUE(check(safe::get_ymd(9999/MAR/ 1), 9999,  2,  0));
  EXPECT_TRUE(check(safe::get_ymd(9999/DEC/ 1), 9999, 11,  0));
  EXPECT_TRUE(check(safe::get_ymd(9999/DEC/31), 9999, 11, 30));
}
