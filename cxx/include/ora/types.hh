...
// We use one bit less than we could so that a daytick can safely be represented
// by a singed int64.
using Daytick = uint64_t;
Daytick constexpr   DAYTICK_PER_SEC     = (Daytick) 1 << (8 * sizeof(Daytick) - SECS_PER_DAY_BITS - 1);
